        ...
        <div className="relative w-full max-w-lg p-4 mx-auto bg-white rounded-md shadow-lg">
          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            ...
            <form onSubmit={(e) => e.preventDefault()}>
              ...
              <button onClick={() => startShipping()} className="block w-full mt-3 py-3 px-4 font-medium text-sm text-center text-white bg-indigo-600 hover:indigo-500 active:bg-indigo-700 rounded-lg ring-offset-2 ring-indigo-600 focus:ring-2">
                    Begin
              </button>
            </form>
          </div>
